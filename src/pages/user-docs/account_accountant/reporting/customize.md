...
When a root report is opened from the Accounting app\'s
...
![Expression line within a line report](customize/engine-expressions.png)
...
[C] and [D] suffixes can be used in the same way
with tags.
